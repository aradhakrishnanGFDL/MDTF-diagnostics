...
#SBATCH --ntasks=1
#SBATCH --chdir=/nbhome/a1r/mdtf/MDTF-diagnostics
#SBATCH -o /nbhome/a1r/mdtf/mdtf_gfdl.csh.1984.printout
...
set argu = ()
set mode = batch
set in_data_dir = "/archive/Huan.Guo/awg/warsaw/c96L33_am4p0/gfdl.ncrc4-intel-prod-openmp/pp/atmos/ts/monthly/5yr/"
#fails /archive/Wenhao.Dong/awg/2021.02/c96L33_am4p0_cmip6Diag_test1/gfdl.ncrc3-intel-prod-openmp/pp/atmos/ts/monthly/1yr/ 

set out_dir = /nbhome/a1r/awg/c96L33_am4p0/
set descriptor = c96L33_am4p0_cmip6Diag_test1
set model = AM4
set yr1 = 2000
set yr2 = 2004 
set WORKDIR = $TMPDIR/c96L33_am4p0
set databegyr = 2000 
set dataendyr = 2004 
set datachunk = 1
set fremodule = fre/bronx-19
set conv = GFDL
set pod_list = '"EOF_500hPa","MJO_suite"'

set script_path

set out_dir = ${out_dir}/mdtf/
## set paths to site installation
set CONDA_ROOT="/home/oar.gfdl.mdtf/miniconda3"
set REPO_DIR="/nbhome/a1r/mdtf/MDTF-diagnostics/"
#"/home/oar.gfdl.mdtf/mdtf/MDTF-diagnostics"
set TEMPLATE_DIR = "/nbhome/a1r/mdtf/MDTF-diagnostics"
...
${REPO_DIR}/mdtf_framework.py -f ${input_jsonc} --site NOAA_GFDL --convention ${conv} -v
